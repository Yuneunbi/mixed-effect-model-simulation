...
sigb <- diag(c(1.5,2.5))
lo <- matrix(c(1,0.5,0.5,1),2,2)

beta <- matrix(c(-0.05,-1.3,-1,0.3,1,0.1),3,2)
...
case1.result <- sim.result
round(case1.result,3)
round(apply(case1.result,2,mean),3) # 예측ㄹ
round(apply(case1.result,2,sd),3)
...
save(p,k,r,g,nt,N,sigb,lo,case1.result, file ="C:/Users/beom/Dropbox/ebyun/
     multinomial/final simualation/case1.RData")
