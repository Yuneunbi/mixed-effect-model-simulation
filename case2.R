...
case2.result <- sim.result
round(case2.result,4)
round(apply(case2.result,2,mean),4)
round(apply(case2.result,2,sd),4)/10
...
save(p,k,r,g,nt,N,sigb,lo,case2.result, file ="C:/Users/beom/Dropbox/ebyun/
     multinomial/final simualation/case2.RData")
