...
case3.result <- sim.result
round(case3.result,4)
round(apply(case3.result,2,mean),4)
round(apply(case3.result,2,sd),4)/10
...
save(p,k,r,g,nt,N,sigb,lo,case3.result, file ="C:/Users/beom/Dropbox/ebyun/
     multinomial/final simualation/case3.RData")
