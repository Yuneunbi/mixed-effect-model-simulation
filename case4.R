...
case4.result <- sim.result
round(case4.result,4)
round(apply(case4.result,2,mean),4)
round(apply(case4.result,2,sd),4)/10
...
save(p,k,r,g,nt,N,sigb,lo,case4.result, file ="C:/Users/beom/Dropbox/ebyun/
     multinomial/final simualation/case4.RData")
