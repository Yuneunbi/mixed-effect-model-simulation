...
case6.result <- sim.result
round(case6.result,4)
round(apply(case6.result,2,mean),4)
round(apply(case6.result,2,sd),4)/10
...
save(p,k,r,g,nt,N,sigb,lo,case6.result, file ="C:/Users/beom/Dropbox/ebyun/
     multinomial/final simualation/case6.RData")
